        ...
        <div className="p-6 sm:p-8 lg:p-12">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex justify-center mb-4 sm:mb-6">
              <div className="text-[10px] sm:text-xs font-bold text-brand uppercase tracking-wider text-center">
                ← Single Task <span className="mx-2 sm:mx-8 text-muted-foreground">to</span> Full Platform →
              </div>
            </div>

            {/* 2x2 Grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-0 border border-brand/20">
              {/* Top Left Quadrant */}
              <div className="sm:border-r border-b border-brand/20 p-6 sm:p-8 bg-black/[0.01] hover:bg-black/[0.03] transition-colors">
                <div className="h-full flex flex-col">
                  <div className="text-[10px] sm:text-xs font-bold text-muted-foreground uppercase tracking-wider mb-4 sm:mb-6">
                    Autonomous • Single Task
                  </div>
                  <div className="space-y-2 sm:space-y-3">
                    {quadrants[0].items.map((item, idx) => (
                      <div key={idx} className="group">
                        <div className="text-xs sm:text-sm font-semibold text-foreground mb-1">{item.name}</div>
                        <div className="text-[10px] sm:text-xs text-muted-foreground">{item.description}</div>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <div className="border-b border-brand/20 p-6 sm:p-8 bg-brand/[0.03] hover:bg-brand/[0.05] transition-colors relative overflow-hidden">
                <div className="absolute top-3 right-3 sm:top-4 sm:right-4">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-brand/20" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
                </div>
                <div className="h-full flex flex-col">
                  <div className="text-[10px] sm:text-xs font-bold text-brand uppercase tracking-wider mb-4 sm:mb-6">
                    ...
                    {quadrants[1].items.map((item, idx) => (
                      <div key={idx} className="group">
                        <div className="inline-block">
                          ...
                          <div className="text-xs sm:text-sm text-foreground font-medium">{item.description}</div>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              <div className="sm:border-r border-b sm:border-b-0 border-brand/20 p-6 sm:p-8 bg-black/[0.01] hover:bg-black/[0.02] transition-colors">
                <div className="h-full flex flex-col">
                  <div className="text-[10px] sm:text-xs font-bold text-muted-foreground uppercase tracking-wider mb-4 sm:mb-6">
              ...
              <div className="p-6 sm:p-8 bg-black/[0.01] hover:bg-black/[0.03] transition-colors">
                <div className="h-full flex flex-col">
                  <div className="text-[10px] sm:text-xs font-bold text-muted-foreground uppercase tracking-wider mb-4 sm:mb-6">
            ...
            <div className="flex justify-center mt-4 sm:mt-6">
              <div className="text-[10px] sm:text-xs font-bold text-brand uppercase tracking-wider text-center">
                ↑ Autonomous <span className="mx-2 sm:mx-8 text-muted-foreground">to</span> Assisted ↓
              </div>
            </div>
          </div>
        </div>
